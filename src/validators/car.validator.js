...
export const CarValidator = Joi.object({
  model: Joi.string().regex(new RegExp(/^[a-zA-Z]{2,30}$/)).required().messages({
    'string.empty':'Field "Model" cannot be empty!',
    'string.pattern.base':'Field "Model" may contain only Latin characters (from 2 to 30)'
  }),
...
// string.pattern.base - regular expression
// number.base - default error for number inputs